...
(function () {
	 ...
	 */
	IonicModule
		.factory('$ionicBind', ['$parse', '$interpolate',
								...
								loader.show = function (options) {
									...
									if (options.duration) {
										...
										this.durationTimeout = $timeout(
											angular.bind(this, this.hide), +options.duration
										);
									}
	 ...
	 */
	IonicModule
		.directive('ionActionSheet', ['$document',
			function ($document) {
				return {
					restrict: 'E',
					scope: true,
	 ...
	 */
	IonicModule
		.directive('ionInfiniteScroll', ['$timeout',
			function ($timeout) {
	 ...
	 */
	IonicModule
		.directive('ionDeleteButton', ['$animate',
			function ($animate) {
				return {
					restrict: 'E',
	 ...
	 */
	IonicModule
		.directive('ionOptionButton', ['$compile',
			function ($compile) {
	 ...
	 */
	IonicModule
		.directive('ionReorderButton', ['$animate',
			function ($animate) {
				return {
					restrict: 'E',
					require: ['^ionItem', '^ionList'],
	 ...
	 */
	IonicModule
		.directive('menuClose', ['$ionicViewService',
	 ...
	 */
	IonicModule
		.directive('menuToggle', ['$ionicViewService',
			function ($ionicViewService) {
				return {
					restrict: 'AC',
					require: '^ionSideMenus',
	 ...
	 */
	IonicModule
		.directive('ionNavButtons', ['$compile', '$animate',
	 ...
	 */
	IonicModule
		.directive('ionRefresher', ['$ionicBind',
			function ($ionicBind) {
				return {
					restrict: 'E',
					replace: true,
		...
		.directive('ionTabNav', [
			function () {
				return {
					...
					replace: true,
					require: ['^ionTabs', '^ionTab'],
					template: '<a ng-class="{\'tab-item-active\': isTabActive(), \'has-badge\':badge}" ' +
						' class="tab-item">' +
